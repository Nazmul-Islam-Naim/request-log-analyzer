...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Request Log Analyzer'); ?></title>
...
<nav class="sidebar">
    ...
    <a class="sidebar-brand" href="<?php echo e(route('request-log-analyzer.dashboard')); ?>">
    ...
    <a href="<?php echo e(route('request-log-analyzer.dashboard')); ?>"
       class="nav-link <?php echo e(request()->routeIs('request-log-analyzer.dashboard') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('request-log-analyzer.requests')); ?>"
       class="nav-link <?php echo e(request()->routeIs('request-log-analyzer.requests') || request()->routeIs('request-log-analyzer.show') || request()->routeIs('request-log-analyzer.timeline') ? 'active' : ''); ?>">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <a href="<?php echo e(route('request-log-analyzer.slow-requests')); ?>"
       class="nav-link <?php echo e(request()->routeIs('request-log-analyzer.slow-requests') ? 'active' : ''); ?>">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <a href="<?php echo e(route('request-log-analyzer.user-route-hits')); ?>"
       class="nav-link <?php echo e(request()->routeIs('request-log-analyzer.user-route-hits') ? 'active' : ''); ?>">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <a href="<?php echo e(route('request-log-analyzer.active-users')); ?>"
       class="nav-link <?php echo e(request()->routeIs('request-log-analyzer.active-users') ? 'active' : ''); ?>">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <a href="<?php echo e(route('request-log-analyzer.login-history')); ?>"
       class="nav-link <?php echo e(request()->routeIs('request-log-analyzer.login-history') ? 'active' : ''); ?>">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <a href="<?php echo e(route('request-log-analyzer.api-insights')); ?>"
       class="nav-link <?php echo e(request()->routeIs('request-log-analyzer.api-insights') ? 'active' : ''); ?>">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <a href="<?php echo e(route('request-log-analyzer.analytics')); ?>"
       class="nav-link <?php echo e(request()->routeIs('request-log-analyzer.analytics') ? 'active' : ''); ?>">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <a href="<?php echo e(route('request-log-analyzer.geo')); ?>"
       class="nav-link <?php echo e(request()->routeIs('request-log-analyzer.geo') ? 'active' : ''); ?>">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <a href="<?php echo e(route('request-log-analyzer.replay.index')); ?>"
       class="nav-link <?php echo e(request()->routeIs('request-log-analyzer.replay.*') ? 'active' : ''); ?>">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <a href="<?php echo e(route('request-log-analyzer.tools')); ?>"
       class="nav-link <?php echo e(request()->routeIs('request-log-analyzer.tools') ? 'active' : ''); ?>">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
<div class="main">
    <div class="topbar">
        ...
        <div class="topbar-right">
            <span class="topbar-badge"><?php echo e(config('request-log-analyzer.route_prefix', 'request-log-analyzer')); ?></span>
        </div>
    </div>
...
<?php /**PATH D:\nintis\Package-Provider\packages\NIN\RequestLogAnalyzer\src/../resources/views/_layout.blade.php ENDPATH**/ ?>