<?php $__env->startSection('page-title', 'Tools'); ?>
    ...
    <div class="export-grid">
        ...
        <div class="export-item">
            ...
            <div class="export-btns">
                <a href="<?php echo e(route('request-log-analyzer.export', ['type' => 'requests', 'format' => 'csv'])); ?>"
                ...
                <a href="<?php echo e(route('request-log-analyzer.export', ['type' => 'requests', 'format' => 'excel'])); ?>"
        ...
        <div class="export-item">
            ...
            <div class="export-btns">
                <a href="<?php echo e(route('request-log-analyzer.export', ['type' => 'errors', 'format' => 'csv'])); ?>"
                   class="btn-export btn-export-csv">
                    <svg style="width:11px;height:11px;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/></svg>
                    CSV
                </a>
                <a href="<?php echo e(route('request-log-analyzer.export', ['type' => 'errors', 'format' => 'excel'])); ?>"
                   class="btn-export btn-export-xlsx">
                    <svg style="width:11px;height:11px;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/></svg>
                    Excel
                </a>
        ...
        <div class="export-item">
            ...
            <div class="export-btns">
                <a href="<?php echo e(route('request-log-analyzer.export', ['type' => 'queries', 'format' => 'csv'])); ?>"
                   class="btn-export btn-export-csv">
                    <svg style="width:11px;height:11px;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/></svg>
                    CSV
                </a>
                <a href="<?php echo e(route('request-log-analyzer.export', ['type' => 'queries', 'format' => 'excel'])); ?>"
                   class="btn-export btn-export-xlsx">
                    <svg style="width:11px;height:11px;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/></svg>
                    Excel
                </a>
...
<div class="card">
    ...
    <?php if(session('rla_cleanup_error')): ?>
        <div class="cleanup-result error">
            <strong>Error:</strong> <?php echo e(session('rla_cleanup_error')); ?>

        </div>
    <?php endif; ?>

    
    <?php if(session('rla_cleanup_done')): ?>
        <?php
        ...
        ?>
        <div class="cleanup-result <?php echo e($isDry ? 'dry' : 'success'); ?>">
            <?php if($isDry): ?>
            ...
            <table class="cleanup-result-table">
                <thead><tr><th>Table</th><th><?php echo e($isDry ? 'Would delete' : 'Deleted'); ?></th></tr></thead>
                <tbody>
                    <?php $__currentLoopData = $totals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $table => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
    ...
    <div class="cleanup-grid">
        ...
        <div class="cleanup-info-row">
            ...
            <div class="cleanup-stat">
                <span class="cleanup-stat-dot" style="background:<?php echo e($cleanupEnabled ? '#22c55e' : '#9ca3af'); ?>;"></span>
                <span>Auto-schedule:
                    <strong><?php echo e($cleanupEnabled ? 'Enabled' : 'Disabled'); ?></strong>
                    <?php if($cleanupEnabled): ?>
                        &mdash; <code style="font-size:.74rem;"><?php echo e($cleanupSchedule); ?></code>
                    <?php endif; ?>
                </span>
            </div>
            ...
            <div class="cleanup-stat">
                ...
                <span>Retention period: <strong><?php echo e($retentionDays); ?> days</strong></span>
            </div>
        ...
        <form method="POST"
              action="<?php echo e(route('request-log-analyzer.cleanup')); ?>"
              class="cleanup-form"
            ...
            <div>
                ...
                <div class="cleanup-input-row">
                    <input id="cleanup-days"
                           ...
                           name="days"
                           min="1"
                           placeholder="<?php echo e($retentionDays); ?>"
                           value="">
                </div>
                <div style="font-size:.72rem;color:#9ca3af;margin-top:.3rem;">
                    Leave blank to use the configured default (<?php echo e($retentionDays); ?> days).
                </div>
            </div>
...
function confirmCleanup(form) {
    ...
    const label = days ? days + ' days' : '<?php echo e($retentionDays); ?> days (default)';
